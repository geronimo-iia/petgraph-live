...
///
/// A vertex is an articulation point if removing it increases the number of
/// connected components. Uses Tarjan DFS, O(V+E).
///
/// # Examples
///
/// ```
/// use petgraph_live::connect::articulation_points;
...
/// let n0 = g.add_node(()); let n1 = g.add_node(());
/// let n2 = g.add_node(()); let n3 = g.add_node(());
/// let n4 = g.add_node(()); let n5 = g.add_node(());
/// g.add_edge(n0, n1, ()); g.add_edge(n1, n2, ());
/// g.add_edge(n2, n3, ()); g.add_edge(n3, n4, ());
/// g.add_edge(n2, n4, ()); g.add_edge(n5, n2, ());
///
